...
export const labData: FeedItem[] = [
  {
    ...
    category: "lab",
    date: "01.06.26",
    title: "🫧 Bubbles Rising — Image Reveal Effect",
    externalUrl: "https://bubble-reveal.netlify.app/"
  },
  {
    ...
    content: [
      {
        ...
        blocks: [
          ...
          {
            type: "text",
            value: "The original codebase suffered from hardcoded repetitive logic and manual state management that made it difficult to maintain."
          },
          {
            type: "text",
            value: " I rewrote the scroll animation system from the ground up, reducing 200+ lines of imperative code down to 80 lines of clean, declarative JavaScript."
          }
        ]
      },
      {
...
// Works for any number of chapters automatically`
          ...
          {
            type: "text",
            value: "Why it matters: New chapters can be added in the HTML without touching the JavaScript. The function uses jQuery's .eq() and .offset() to calculate positions dynamically."
          },
    ...
    moSecHeritageTl = gsap.timeline({
      scrollTrigger: {
        onEnter: () => $timelineWrap.addClass("fixed")
          ...
          {
            type: "text",
            value: "Why it matters: Each device has its own isolated ScrollTrigger. GSAP handles cleanup and re-initialization on resize automatically."
          },
...
onUpdate: function (self) {
  ...
  pcSecHeritageTl.to({}, {
    ...
    onReverseComplete: () => activeTimeline(idx - 1)
          ...
          {
            type: "text",
            value: "Why it matters: Eliminated 4 flag variables and all the progress calculation logic. ScrollTrigger handles forward and backward scrolling naturally."
          }
        ]
      },
      {
        ...
        blocks: [
          ...
          {
            type: "text",
            value: "This refactor wasn't just about writing less code — it was about writing better code. Instead of manually handling each chapter with separate if statements, I used index-based loops to automate the process."
          },
          {
            type: "text",
            value: "This shifted the code from telling the browser 'how to scroll' step-by-step to simply declaring 'what to animate,' making it simpler and more reliable."
          }
        ]
      }
    ]
